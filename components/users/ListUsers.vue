<template>
    <div class="mx-auto max-w-screen-lg px-4 py-8 sm:px-8">
        <div class="flex items-center justify-between pb-6">
            <div>
                <h2 class="font-semibold text-gray-700">Usuarios</h2>
            </div>
        ...
        <div class="overflow-y-hidden rounded-lg border">
            ...
            <table class="w-full">
                ...
                <tr>
                    ...
                    <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                    <p class="whitespace-no-wrap">Administrador</p>
                    </td>
                    <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
            ...
            <span class="text-xs text-gray-600 sm:text-sm"> Mostrando 1 a 5 de 12 Registros </span>
