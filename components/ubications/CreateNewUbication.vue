<template>
    <section v-if="!computedShowModal">
        ...
        <div class="flex justify-center">
            ...
            <div>
                <label for="nameUbication" class="block text-sm text-gray-600">Nombre de la Ubicacion</label>
            ...
            <div class="mt-5">
                <label for="Locations" class="block mb-2 text-sm text-gray-600">Seleccione la Sede </label>
            ...
            <div class="mt-5">
                <label for="floor" class="block mb-2 text-sm text-gray-600">Seleccione el Piso </label>
            ...
            <div class="mt-5">
                <label for="typeUbication" class="block mb-2 text-sm text-gray-600">Seleccione el tipo de ubicacion</label>
            ...
            <div class="mt-5" v-if="selectedTypeUbication.id === 2">
                <label for="direction" class="block mb-2 text-sm font-medium text-gray-600">Seleccione la direccion</label>
            ...
            <div class="mt-5">
                <label for="Description" class="block text-sm text-gray-600">{{selectedTypeUbication.id === 2 ? 'Indicacion' : 'Descripcion'}}</label>
